...
<html>
  ...
  <body>
	...
	<form action="OutRespoRecord.do?page=1" method = "post">
    ...
    <c:if test="${not empty requestScope.showOutView }">
		<table class = "table table-bordered table-hover">
			<tr>
				...
				<th class="col-md-2">OutTime</th>
				<th class="col-md-2">OutCompany</th>
				<th class="col-md-2">OutName</th>
			</tr>
			
			<c:forEach var="c" items="${requestScope.showOutView }">
	...
	<c:if test="${requestScope.number != 0}">
		<ul class = "pager">
		<li><a href = "OutRespoRecord.do?page=1&goodsName=${param.goodsName }&dateTime=${param.dateTime }">首页</a></li>
		<c:forEach var="i" begin="1" end="${requestScope.number/5 + 1 }" step="1">
			<li><a href = "OutRespoRecord.do?page=${i }&goodsName=${param.goodsName }&dateTime=${param.dateTime }">第${i }页</a></li>
		</c:forEach>
		<li><a href = "OutRespoRecord.do?page=<fmt:formatNumber type="number" value="${requestScope.number/5 + 1 }" maxFractionDigits="0"/>&goodsName=${param.goodsName }&dateTime=${param.dateTime } ">末页</a><br><br><br></li></ul>
	</c:if>
  </body>
</html>
